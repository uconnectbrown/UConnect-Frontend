const courseList = [
  ...
  // ["AFRI 10["AFRI 0800", "Theorizing Racism"],50E", "RPM Playwriting"],
  ...
  [
    "AMST 2221A",
    "Accessioning, Archiving, and Antiracism: Critical and Creative Approaches",
  ],
  ...
  ["ETHN 090A", "The Border/La Frontera"],
  ...
  [
    "ETHN 1750X",
    "Native American Language Loss, Revitalization, and Resiliency",
  ],
  ...
  ["APMA 2550", "Numerical Solutions of Partial Differential Equations I"],
  ["APMA 2570A", "Numerical Solutions of Partial Differential Equations III"],
  ...
  [
    "ARCH 1670",
    `The Beginning of the End? Neolithic "Revolutions" and the Shaping of the Modern World`,
  ],
  // [
  //   "ARCH 1765",
  ...
  ["BIOL 0380", "The Ecology and Evolution of Infectious Diseases"],
  ...
  ["SANS 1030", "The Bhagavata Purana: Text and Reception"],
  // ["SANS 1500", "Sanskrit Song and Music"],
  ["SANS 1970", "Independent Study - Special Topics"],
  ["SANS 1990", "Conference: Especially for Honors Students"],
  ...
  ["CLPS 0120", "Introduction to Sleep"],
  ...
  ["CSCI 0082", "TA Apprenticeship: Full Credit"],
  ...
  [
    "EEPS 0160P",
    "From Human Migration to Solving Crimes: The World of Forensic Isotopes",
  ],
  ...
  [
    "EDUC 1490",
    "Discipline and Punish: Historical Inisghts on School Punishment",
  ],
  ...
  ["ENGN 1700", "Fluid Mechanics of Aerospace and Energy Systems"],
  ...
  ["ENGN 2150", "Technology Entrepreneurship and Commercialization I"],
  ...
  ["ENGN 2700", "Big Data and Machine Learning Digital Enterprises"],
  ...
  ["ENGL 0200C", "Stories of Speculation: Fabulism and Narrative Realism"],
  ...
  ["IAPA 1701B", "Cyber Security: Strategy and Policy"],
  ...
  ["MUSC 1810", "Applied Music Program"],
  ...
  ["PHIL 0351", "Nietzche's Zarathustra"],
  ...
  ["POLS 0200", "Introductory Polish"],
  ["POLS 0600", "Advanced Polish"],
  ...
  [
    "POBS 0630A",
    "The nature of things: an object-oriented approach to Lusophone studies",
  ],
  ...
  [
    "POBS 1601P",
    "Global Decolonization in Africa and Asia: the Portuguese Case in a Comparative Perspective",
  ],
  ...
  ["RELS 0825", "Foundational Texts in African American Technology"],
  ...
  [
    "TAPS 2200U",
    "New Directions in Performance Theory: Pedagogy, Enchantment, Utopia",
  ],
  ...
  ["URBN 1981", "Honors Thesis Workship"],
...
const codes = (
  <datalist id="codes">
    {courseList.map((course) => {
      return <option value={`${course[0]}: ${course[1]}`} />;
    })}
  </datalist>
);

export { codes, courseList };
